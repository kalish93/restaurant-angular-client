...
// export const MEDIA_URL = 'https://127.0.0.1:4000.com/api/uploads';

export const BASE_URL = 'https://api.mesobfoods.com';
export const API_BASE_URL = 'https://api.mesobfoods.com/api';
export const MEDIA_URL = 'https://media.mesobfoods.com';
